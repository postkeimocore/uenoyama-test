  ...
  return (
    <nav style={{
      ...
      background: mobileOpen
        ? C.cream
        : (pastHero ? "rgba(245,240,232,0.85)" : "rgba(0,0,0,0.28)"),
      backdropFilter: mobileOpen ? "none" : "blur(8px)",
      WebkitBackdropFilter: mobileOpen ? "none" : "blur(8px)",
...
// ============ HOME PAGE ============
// ============ X (Twitter) 公式埋め込みウィジェット (フォールバック付き) ============
function XEmbedTimeline() {
  ...
  useEffect(() => {
    ...
    // 5秒経過してもtweetがレンダリングされていなければフォールバック
    const t = setTimeout(() => {
  ...
  if (failed) {
    return (
      <div style={{
        background: C.warmGray, minHeight: 380, padding: "48px 32px",
        display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
        textAlign: "center",
      }}>
        <div dangerouslySetInnerHTML={{ __html: SVG_X(28) }} style={{ marginBottom: 20, color: C.darkGreen }} />
        <p style={{
          fontFamily: "'Noto Sans JP', sans-serif", fontSize: 14,
          color: C.charcoal, opacity: 0.75, lineHeight: 2, marginBottom: 28,
        }}>
          最新の投稿はXでご覧いただけます
        </p>
        <a href={SOCIAL.x} target="_blank" rel="noopener noreferrer"
          style={{
            display: "inline-block",
            fontFamily: "'Noto Serif JP', serif", fontSize: 13, letterSpacing: "0.22em",
            color: C.midGreen, textDecoration: "none",
            borderBottom: `1px solid ${C.midGreen}`, paddingBottom: 4,
          }}>
          @tuyosiusi をXで見る →
        </a>
      </div>
      ...
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: "120px 60px" }}>
        ...
        <FadeIn>
          <div style={{ marginBottom: 120 }}>
            ...
            <div className="resp-feature-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0 }}>
              {[
      ...
      <section style={{ maxWidth: 1200, margin: "0 auto", padding: isMobile ? "72px 20px" : "120px 60px" }}>
        ...
        <FadeIn>
          <div style={{
            ...
            <div style={{ background: C.warmGray, marginTop: isMobile ? 0 : 44 }}>
              {[
                {
                  title: "①7~10年以上放牧で育つ",
