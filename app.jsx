...
// ============ HOME PAGE ============
// ============ X (Twitter) リンクUI ============
// widgets.jsは環境依存で表示されないケースが多いため、Phase 1ではXへの誘導UIで代替。
// Phase 2でX API直接連携に置き換え予定。
function XEmbedTimeline() {
  return (
    <div style={{
      background: C.warmGray, minHeight: 380, padding: "60px 32px",
      display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center",
      textAlign: "center",
    }}>
      <div dangerouslySetInnerHTML={{ __html: SVG_X(32) }} style={{ marginBottom: 24, color: C.darkGreen }} />
      <p style={{
        fontFamily: "'Shippori Mincho', serif", fontSize: 17,
        color: C.darkGreen, lineHeight: 1.8, marginBottom: 12, letterSpacing: "0.06em",
      }}>
        最新の投稿はXでご覧いただけます
      </p>
      <p style={{
        fontFamily: "'Noto Sans JP', sans-serif", fontSize: 13,
        color: C.charcoal, opacity: 0.65, lineHeight: 1.9, marginBottom: 32,
      }}>
        日々の放牧場の様子や、活動の記録を発信中。
      </p>
              ...
              {[
                ...
                <div key={c.title} style={{ background: C.warmGray, overflow: "hidden" }}>
                  ...
                  <div style={{ padding: "24px 22px" }}>
                    ...
                    <p style={{ fontFamily: "'Noto Sans JP', sans-serif", fontSize: 12, lineHeight: 1.9, opacity: 0.75 }}>{c.desc}</p>
                  </div>
                </div>
              ))}
            </div>
